...
export const EnsCard = ({ records }: EnsCardProps) => {
    ...
    return (
        <Link href={`/${records.ens}`} className="flex flex-row p-2.5 gap-2.5 items-center rounded-[6px] border-[1px] border-border">
