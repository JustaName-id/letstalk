    ...
    return (
        <div className="flex flex-col w-full gap-8">
            ...
            <div className="flex flex-col items-center gap-8">
                <div className="transform scale-75  origin-top rounded-[12px] border-[3px] p-4 border-[#E4E4E7] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.10),_0px_10px_10px_-5px_rgba(0,0,0,0.04)]">
                    {records && (
