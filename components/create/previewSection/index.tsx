...
export const PreviewSection = () => {
    ...
    return (
        <div className="flex flex-col overflow-hidden justify-between w-full h-[calc(100vh-40px)] gap-8">
            ...
            <div className="flex flex-col gap-4">
                <div className="transform h-full scale-75 flex origin-top rounded-[12px] border-[3px] p-4 border-[#E4E4E7] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.10),_0px_10px_10px_-5px_rgba(0,0,0,0.04)]">
                    {records && (
