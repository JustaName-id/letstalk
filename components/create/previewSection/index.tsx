...
export const PreviewSection = () => {
    ...
    return (
        <div className="flex flex-col relative  justify-between w-full gap-5">
            ...
            <div className="flex flex-col max-h-[80vh] w-full overflow-hidden">
                <div className="transform scale-75 flex origin-top rounded-[12px] border-[3px] p-4 border-[#E4E4E7] shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.10),_0px_10px_10px_-5px_rgba(0,0,0,0.04)] overflow-hidden">
                    {records && (
